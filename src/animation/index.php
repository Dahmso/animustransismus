        ...
        <div class="row ctn-demo">
          ...
          <div class="lightbox" id="text1">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/bounce.png" alt="code de l'animation bounce" />
              </div>
            </div>
          </div>
          ...
          <div class="lightbox" id="text2">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/flash.png" alt="code de l'animation flash" />
              </div>
            </div>
          </div>
          ...
          <div class="lightbox" id="text3">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/pulse.png" alt="code de l'animation pulse" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row ctn-demo">
          ...
          <div class="lightbox" id="text4">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/rubberBand.png" alt="code de l'animation rubberBand" />
              </div>
            </div>
          </div>
          ...
          <div class="lightbox" id="text5">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/shake.png" alt="code de l'animation shake" />
              </div>
            </div>
          </div>
          ...
          <div class="lightbox" id="text9">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/jello.png" alt="code de l'animation jello" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row ctn-demo">
          ...
          <div class="lightbox" id="text7">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/tada.png" alt="code de l'animation tada" />
              </div>
            </div>
          </div>
          ...
          <div class="lightbox" id="text8">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/wobble.png" alt="code de l'animation wobble" />
              </div>
            </div>
          </div>
          ...
          <div class="lightbox" id="text6">
            <div class="box">
              ...
              <div class="content">
                <img src="./src/animation/img/swing.png" alt="code de l'animation swing" />
              </div>
            </div>
          </div>
        </div>
